...
html_logo = '_static/gkn_logo_small.png'
...
latex_documents = [
    (master_doc, 'pansys.tex', 'pansys Documentation',
     'Najeem Muhammed', 'manual'),
]

pdf_documents = [
        ('index',u'pansys_documentation',u'pansys Documentation', 
            u'Najeem Muhammed'),
        ]
...
man_pages = [
    (master_doc, 'pansys', 'pansys Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pansys', 'pansys Documentation',
     author, 'pansys', 'One line description of project.',
     'Miscellaneous'),
]
